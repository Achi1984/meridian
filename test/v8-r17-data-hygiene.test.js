...
const trade=fs.readFileSync(new URL('../v8-clean/trade-details-r12.js',import.meta.url),'utf8').replaceAll('\r\n','\n');
const index=fs.readFileSync(new URL('../v8-clean/index.html',import.meta.url),'utf8').replaceAll('\r\n','\n');
const label=fs.readFileSync(new URL('../v8-clean/layout-r17.js',import.meta.url),'utf8').replaceAll('\r\n','\n');
