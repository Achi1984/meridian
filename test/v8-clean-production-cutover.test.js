...
test('clean target remains the five-view R8 shell',()=>{
  ...
  assert.match(clean,/r8-polish\.css\?v=8\.0-clean-r8/);
  assert.match(clean,/app\.js\?v=8\.0-clean-r8/);
  assert.match(clean,/more-runtime\.js\?v=8\.0-clean-r8/);
});
