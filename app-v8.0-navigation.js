...
(function(){
  ...
  function css(){if(document.getElementById('v8-navigation-css'))return;const s=document.createElement('style');s.id='v8-navigation-css';s.textContent=`
    ...
    #v8-bottom-nav button{min-width:0;min-height:48px;border:0;border-radius:13px;background:transparent;color:#70889a;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:5px 2px;font:900 8px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.07em;touch-action:manipulation;pointer-events:auto!important}
    ...
    #v8-bottom-nav button.active{color:#55c8ff;background:#071a27;box-shadow:inset 0 0 0 1px rgba(85,200,255,.14)}#v8-bottom-nav button.active i{border-color:#228fc2;color:#9de2ff;background:#082335}
    ...
    html.v8-nav-ready #v8-center-summary,html.v8-nav-ready #v8-depot-summary,html.v8-nav-ready #v8-trade-summary,html.v8-nav-ready #v8-paper-summary{margin-bottom:18px!important}html.v8-nav-ready .v8-customer-screen{max-width:760px!important}
    @media(max-width:430px){html.v8-nav-ready #v8-customer-mode{margin:7px 10px 4px!important;padding:9px 10px!important;border-radius:13px!important;gap:4px!important}html.v8-nav-ready #v8-customer-mode b{font-size:10px!important}html.v8-nav-ready #v8-customer-mode span{font-size:7px!important;line-height:1.3!important}#v8-bottom-nav{padding-left:7px;padding-right:7px;padding-top:5px}.v8-nav-inner{gap:3px;border-radius:16px;padding:3px}#v8-bottom-nav button{min-height:46px;font-size:7px;letter-spacing:.04em;gap:3px;border-radius:11px}#v8-bottom-nav button i{width:16px;height:16px}html.v8-nav-ready .v8-customer-screen{padding-left:10px!important;padding-right:10px!important;margin-top:8px!important}html.v8-nav-ready .v8-center-hero,html.v8-nav-ready .v8-depot-head{padding:14px!important;border-radius:16px!important}html.v8-nav-ready .v8-center-card,html.v8-nav-ready .v8-depot-perf>div,html.v8-nav-ready .v8-depot-split>div,html.v8-nav-ready .v8-depot-top{border-radius:12px!important}}
