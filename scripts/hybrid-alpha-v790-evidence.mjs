...
function buildSamples(data,symbol,horizonBars){
  ...
  for(let i=800;i<xs.length-horizonBars;i++){
    ...
    out.push({timestamp:new Date(xs[i].t).toISOString(),symbol,forwardR,features:{regime:regimeOf(btc,bi,b20,b50,b200,ba14),trend,momentum,relativeStrength,meanReversion,volatilityRatio,liquidityQuality,reversalRisk,timeframeEvidence:{trend15m:trend15,trend1h,trend4h}}});
  }
  return out;
}
