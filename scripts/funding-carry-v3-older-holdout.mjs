...
const AUDIT_START=Date.parse('2020-01-01T00:00:00.000Z');
const AUDIT_END=Date.parse('2021-12-01T00:00:00.000Z');
const FUNDING_START=Date.parse('2019-12-01T00:00:00.000Z');
...
try{
  ...
  const gates={
    ...
    profitFactor:profitFactor>=1.25,
    profitableShare:winShare>=(2/3),
  ...
  const out={
    schemaVersion:'FUNDING-CARRY-V3-OLDER-HOLDOUT-1',generatedAt:new Date().toISOString(),researchOnly:true,executionImpact:false,
    productionRuleset:'8.40-PAPER-BTC-FUNDING-CARRY-V2-COST-AMORTIZED',predeclaredDesign:'research/funding-carry-v3-older-holdout-design.md',
  ...
  await fs.writeFile('artifacts/funding-carry-v3-older-holdout.json',JSON.stringify(out,null,2));
