...
function commandCenter(){
 ...
 return moduleSafe('DUAL GATE',()=>dualGatePanel())+
 moduleSafe('LIVE RISK COCKPIT',()=>liveRiskCockpitPanel())+
 moduleSafe('DYNAMIC RECOVERY',()=>compactRecoveryPanel())+
 moduleSafe('ENTRY INTELLIGENCE',()=>entryIntelligencePanel())+
 moduleSafe('RISK DETAILS',()=>centerAdvancedRiskDetails())+
 `<div class="cc-hero">
 ...
 `<div class="cc-grid">
   ...
   <div class="cc-tile"><span>PORTFOLIO HEDGE</span><b class="amber">${fmt(hedgeCapitalPct,1)}%</b><small>EXPOSURE RATIO · nicht Liq.-Puffer</small></div>
 </div>`+
