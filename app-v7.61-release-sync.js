/* MERIDIAN v7.61 R6 — release/cache authority bridge. UI only; execution unchanged. */
(function(){
  'use strict';
  const VERSION='7.61';
  const BUILD='7.61-20260904-R6';
  const STYLE_ID='meridian-v761-r6-tabs';
  ...
  function tabStyle(){
    ...
    s.textContent=`
      ...
      #view-trade .segment-nav button{
        min-height:42px!important;height:42px!important;padding:0 12px!important;margin:0!important;
        border:1px solid transparent!important;border-radius:11px!important;background:transparent!important;
        color:#8293a7!important;font-size:11px!important;font-weight:900!important;
        letter-spacing:.08em!important;line-height:1!important;box-shadow:none!important
      }
