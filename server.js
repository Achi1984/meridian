...
function compactBaselinePaperState(state={}){
  return {
    ruleset:state.ruleset||null,
    account:state.account||{},
    positions:(state.positions||[]).filter(x=>x?.status==='OPEN'),
    trades:(state.trades||[]).filter(x=>x?.status==='CLOSED'),
