...
(function(){
  ...
  if(document.readyState==='loading'){
    ...
    document.write('<script src="app-runtime-monitor.js?v=7.61-R6"><\/script>');
    ...
    document.write('<script src="app-v7.61-release-sync.js?v=7.61-R6"><\/script>');
    return;
  }
  const load=src=>new Promise((resolve,reject)=>{const s=document.createElement('script');s.src=src;s.async=false;s.onload=resolve;s.onerror=reject;document.head.appendChild(s)});
  load('app-v7.32-legacy.js?v=7.60-R1')
    .then(()=>load('app-v7.33-hardening.js?v=7.60-R1'))
    .then(()=>load('app-runtime-monitor.js?v=7.61-R6'))
    ...
    .then(()=>load('app-v7.61-release-sync.js?v=7.61-R6'))
